 ...
 * @author error414
 */
public class GovernorThrActivity extends BaseActivity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        ((TextView) findViewById(R.id.title)).setText(TextUtils.concat(getTitle(), " \u2192 ", getString(R.string.governor_thr)));

		//naplnime seznam polozek pro menu
		menuListIndex = Menu.getInstance().getItemForGroup(Menu.MENU_INDEX_GOVERNOR_THR);
		...
		menuList.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				Intent i = new Intent(GovernorThrActivity.this, Menu.getInstance().getItem(menuListIndex[position]).getActivity());
				startActivity(i);
			}
		});
