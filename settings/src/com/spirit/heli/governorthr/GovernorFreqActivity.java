...
public class GovernorFreqActivity extends BaseActivity
{
	...
	final private String TAG = "GovernorFreqActivity";

	final private int PROFILE_CALL_BACK_CODE = 16;

	private final String protocolCode[] = {"GOVERNOR_FREQ",};

	private int formItems[] = {R.id.governor_freq_select_id};
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		initSlideMenu(R.layout.governor_freq);

		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
		((TextView) findViewById(R.id.title)).setText(TextUtils.concat(getTitle(), " \u2192 ", getString(R.string.governor_thr), " \u2192 ", getString(R.string.governor_freq)));
