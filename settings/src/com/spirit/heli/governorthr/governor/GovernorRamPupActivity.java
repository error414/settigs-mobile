...
public class GovernorRamPupActivity extends BaseActivity {
    ...
    private final String protocolCode[] = {"GOVERNOR_RAMPUP",};

    private int formItems[] = {R.id.governor_rampup,};

    private int formItemsTitle[] = {R.string.governor_rampup,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initSlideMenu(R.layout.governor_rampup);

        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
        ((TextView) findViewById(R.id.title)).setText(TextUtils.concat("... \u2192 ", getString(R.string.governor_thr), " \u2192 ", getString(R.string.governor), " \u2192 ", getString(R.string.governor_rampup)));
    ...
    private void initGui() {
        for (int i = 0; i < formItems.length; i++) {
            ...
            tempPicker.setTranslate(new GovernorRamPupProgressExTranslate());
            tempPicker.setStepPress(10);
            tempPicker.setStepLongPress(10);
            tempPicker.setRange(10, 200); // nastavuji rozmezi prvku z profilu
        }
    }
