...
public class AutorotationBailOutActivity extends BaseActivity
{

	final private String TAG = "RpmSenzorFilterActivity";

	final private int PROFILE_CALL_BACK_CODE = 16;

	private final String protocolCode[] = {"AUTOROTATION_BAILOUT",};

	private int formItems[] = {R.id.autorotation_bailout,};

	private int formItemsTitle[] = {R.string.autorotation_bailout,};
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		initSlideMenu(R.layout.autorotation_bailout);

		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
		((TextView) findViewById(R.id.title)).setText(TextUtils.concat("... \u2192 ", getString(R.string.advanced_expert), " \u2192 ",  getString(R.string.autorotation_bailout)));
	...
	private void initGui()
	{
		for (int i = 0; i < formItems.length; i++) {
			...
			tempPicker.setTranslate(new AutorotationBailOutProgressExTranslate());
		}
	}
