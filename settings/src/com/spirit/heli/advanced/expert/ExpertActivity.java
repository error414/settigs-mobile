...
package com.spirit.heli.advanced.expert;
...
public class ExpertActivity extends BaseActivity
{
	...
	final private String TAG = "ExpertActivity";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		((TextView) findViewById(R.id.title)).setText(TextUtils.concat(getTitle(), " \u2192 ", getString(R.string.advanced_expert)));

		//naplnime seznam polozek pro menu
		menuListIndex = Menu.getInstance().getItemForGroup(Menu.MENU_INDEX_ADVANCED_EXPERT);
		...
		menuList.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				Intent i = new Intent(ExpertActivity.this, Menu.getInstance().getItem(menuListIndex[position]).getActivity());
				startActivity(i);
			}
		});
		...
		menuList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
		{
			...
			public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long id)
			{
				...
				new AlertDialog.Builder(ExpertActivity.this).setTitle(R.string.add_to_favourites).setMessage(Menu.getInstance().getItem(menuListIndex[position]).getTitle()).setPositiveButton(prefs.getAll().containsKey(String.valueOf(menuListIndex[position])) ? R.string.remove : R.string.add, new DialogInterface.OnClickListener()
				{
