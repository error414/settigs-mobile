...
public class RpmSenzorFilterActivity extends BaseActivity
{
	...
	private final String protocolCode[] = {"RPM_SENZOR_FILTER",};

	private int formItems[] = {R.id.rpm_senzor_filter,};

	private int formItemsTitle[] = {R.string.rpm_senzor_filter,};
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		initSlideMenu(R.layout.rpm_senzor_filter);

		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
		((TextView) findViewById(R.id.title)).setText(TextUtils.concat("... \u2192 ", getString(R.string.advanced_expert), " \u2192 ",  getString(R.string.rpm_senzor_filter)));
