...
public class ColDirectionActivity extends BaseActivity {

    @SuppressWarnings("unused")
    final private String TAG = "ColDirectionActivity";

    final private int PROFILE_CALL_BACK_CODE = 16;

    private final String protocolCode[] = {"COLPITCH_REV",};

    private int formItems[] = {R.id.col_direction,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initSlideMenu(R.layout.advanced_col_direction);

        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
        ((TextView) findViewById(R.id.title)).setText(TextUtils.concat("... \u2192 ", getString(R.string.col_direction)));
