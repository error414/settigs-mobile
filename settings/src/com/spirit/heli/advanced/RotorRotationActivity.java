...
package com.spirit.heli.advanced;
...
public class RotorRotationActivity extends BaseActivity {

    @SuppressWarnings("unused")
    final private String TAG = "RotorRotationActivity";

    final private int PROFILE_CALL_BACK_CODE = 16;

    private final String protocolCode[] = {"ROTOR_ROTATION",};

    private int formItems[] = {R.id.rotor_rotation,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initSlideMenu(R.layout.advanced_rotor_rotation);

        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
        ((TextView) findViewById(R.id.title)).setText(TextUtils.concat("... \u2192 ", getString(R.string.rotor_rotation)));
