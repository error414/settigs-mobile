...
public class LimitAilRangeActivity extends BaseActivity
{

	@SuppressWarnings("unused")
	final private String TAG = "LimitAilRangeActivity";

	final private int PROFILE_CALL_BACK_CODE = 16;

	private final String protocolCode[] = {"LIMIT_RANGE_AILE_U","LIMIT_RANGE_AILE_D",};

	private int formItems[] = {R.id.limit_range_ail_left, R.id.limit_range_ail_right,};
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		initSlideMenu(R.layout.limit_range_ail);

		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
		((TextView) findViewById(R.id.title)).setText(TextUtils.concat("...", " \u2192 ", getString(R.string.limits), " \u2192 ",  getString(R.string.limit_range_ail)));
